/*
  paths.js
  ----------------
  Rutas del proyecto en disco (servidor Node y sitio estatico).
  - Expone `serverRoot`, `projectRoot` y `publicHtmlPath`.
  - Resuelve la carpeta del frontend: `PUBLIC_HTML_PATH`, `public_html` o legacy `WireFrame`.
...
// Ruta resuelta una vez al arrancar el proceso.
